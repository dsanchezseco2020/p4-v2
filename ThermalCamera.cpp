...
ThermalCamera::ThermalCamera(bool on, int id) : Sensor(on, id, Sensor::THERMAL_CAMERA) {
}

std::string ThermalCamera::collectData() {
...
std::ostream& operator<<(std::ostream& os, ThermalCamera& camera) {
